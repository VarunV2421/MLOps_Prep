...
print("Checking the data for poisoning of labels")
def find_suspicious_labels(data_path, k=5, threshold=0.5):
    ...
    X = df.drop(columns=['species', 'Time', 'Class'], errors='ignore')
    y = df['Class']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-path", type=str, default="data/iris.csv", help="Path to the input CSV file.")
